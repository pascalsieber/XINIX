...
public interface ManagedObjectRegistry extends LifecycleObject
{
	...
	public void registerManagedObjectType( LifecycleManager< ? > lifecycleManager, String name, Scope scope, Transactionality transactionality, int poolSize, String entityManager );
