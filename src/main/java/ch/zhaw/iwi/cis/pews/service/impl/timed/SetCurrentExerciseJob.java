...
public class SetCurrentExerciseJob implements Job
{
	...
	public void execute( JobExecutionContext context ) throws JobExecutionException
	{
		try
		{
			...
			sessionService.setCurrentExercise( ( (DelayedSetCurrentExerciseRequest)schedulerContext.get( "request" ) ).getSession() );
		}
