...
public class ZhawEngine implements LifecycleObject
{
	...
	private static void configureDemoWorkshop()
	{
		...
		/*
		 * sample data exerciseDataService.persist( new PinkLabsExerciseData( rootUser, (WorkflowElementImpl)exerciseService.findByID( pinklabsExID ), Arrays.asList( "Internet", "Zeitungen" ) ) );
		 * 
		 * String p2pOneDataID = exerciseDataService.persist( new P2POneData( rootUser, (WorkflowElementImpl)exerciseService.findByID( p2poneExID ), Arrays.asList( "Spass", "Spontan" ) ) );
		 * 
		 * exerciseDataService.persist( new You2MeExerciseData( rootUser, (WorkflowElementImpl)exerciseService.findByID( you2meExID ), Arrays.asList( new DialogEntry( DialogRole.RoleA, "Englisch" ),
		 * new DialogEntry( DialogRole.RoleB, "Nach Kalifornien in die Ferien gehen" ) ) ) );
		 * 
		 * Set< P2POneKeyword > keywords = new HashSet<>(); P2POneData p2pOneData = exerciseDataService.findByID( p2pOneDataID ); keywords.add( p2pOneData.getKeywords().get( 0 ) ); keywords.add(
		 * p2pOneData.getKeywords().get( 1 ) );
		 * 
		 * exerciseDataService.persist( new P2PTwoData( rootUser, (WorkflowElementImpl)exerciseService.findByID( p2ptwoExID ), Arrays.asList( "Online Werbung", "Wettbewerb mit Kinogutscheinen" ),
		 * keywords ) );
		 * 
		 * Set< String > associations = new HashSet<>(); associations.addAll( Arrays.asList( "Sicherheit", "Verbindung", "Zahlen" ) ); exerciseDataService.persist( new XinixData( rootUser,
		 * (WorkflowElementImpl)exerciseService.findByID( xinixExID ), associations, XINIX_IMAGES.iterator().next() ) );
		 * 
		 * exerciseDataService .persist( new SimplePrototypingData( rootUser, (WorkflowElementImpl)exerciseService.findByID( simplePrototypingExID ), DatatypeConverter .parseBase64Binary(
		 * ""
		 * ) ) );
		 * 
		 * CompressionExerciseData compressionData = exerciseDataService.findByID( exerciseDataService.persist( new CompressionExerciseData( rootUser, (WorkflowElementImpl)exerciseService .findByID(
		 * compressionExID ), Arrays.asList( new CompressionExerciseDataElement( "Werbekampagne auf Youtube", "Werbekampagne auf Youtube wird unserem Produkt helfen." ), new
		 * CompressionExerciseDataElement( "Werbekampagne auf Facebook", "Werbekampagne auf Facebook wird unserem Produkt helfen." ) ) ) ) );
		 * 
		 * exerciseDataService.persist( new EvaluationExerciseData( rootUser, (WorkflowElementImpl)exerciseService.findByID( evaluationExID ), new Evaluation( rootUser, compressionData .getSolutions()
		 * .get( 0 ), new Score( rootUser, 4 ) ) ) );
		 */
