...
public class BootstrapService {
    ...
    private UserImpl rootUser;

    public void configureRootUser()
    {
        RoleService roleService = ZhawEngine.getManagedObjectRegistry().getManagedObject( RoleServiceImpl.class.getSimpleName() );
        UserService userService = ZhawEngine.getManagedObjectRegistry().getManagedObject( UserServiceImpl.class.getSimpleName() );
        ClientService clientService = ZhawEngine.getManagedObjectRegistry().getManagedObject( ClientServiceImpl.class.getSimpleName() );
    ...
    public void configureSampleWorkshop()
    {
        UserService userService = ZhawEngine.getManagedObjectRegistry().getManagedObject( UserServiceImpl.class.getSimpleName() );
        RoleService roleService = ZhawEngine.getManagedObjectRegistry().getManagedObject( RoleServiceImpl.class.getSimpleName() );
        ...
        WorkshopTemplateService workshopTemplateService = ZhawEngine.getManagedObjectRegistry().getManagedObject( WorkshopTemplateServiceImpl.class.getSimpleName() );
        WorkshopService workshopService = ZhawEngine.getManagedObjectRegistry().getManagedObject( WorkshopServiceImpl.class.getSimpleName() );
        ExerciseTemplateService exerciseTemplateService = ZhawEngine.getManagedObjectRegistry().getManagedObject( ExerciseTemplateServiceImpl.class.getSimpleName() );
        ExerciseService exerciseService = ZhawEngine.getManagedObjectRegistry().getManagedObject( ExerciseServiceImpl.class.getSimpleName() );
        ExerciseDataService exerciseDataService = ZhawEngine.getManagedObjectRegistry().getManagedObject( ExerciseDataServiceImpl.class.getSimpleName() );
        InvitationService invitationService = ZhawEngine.getManagedObjectRegistry().getManagedObject( InvitationServiceImpl.class.getSimpleName() );
        XinixImageMatrixService xinixImageMatrixService = ZhawEngine.getManagedObjectRegistry().getManagedObject( XinixImageMatrixServiceImpl.class.getSimpleName() );
        MediaService mediaService = ZhawEngine.getManagedObjectRegistry().getManagedObject( MediaServiceImpl.class.getSimpleName() );
        ...
        String pinklabsTemplateID = exerciseTemplateService.persist( new PinkLabsTemplate( rootUser, true, TimeUnit.SECONDS, 120, true, false, false, 0, (WorkshopTemplate)workshopTemplateService
            .findWorkshopTemplateByID( wsTemplateID ), "Wo oder wie informierst Du Dich im Alltag?", "p.i.n.k.labs", "p.i.n.k.labs Tool" ) );
        ...
        String you2meTemplateID = exerciseTemplateService.persist( new You2MeTemplate( rootUser, true, TimeUnit.MINUTES, 2, true, false, false, 0, (WorkshopTemplate)workshopTemplateService
            .findWorkshopTemplateByID( wsTemplateID ), "Führe mit jemandem einen Dialog.", "You2Me", "You2Me Tool", new HashSet<>( Arrays.asList(
        ...
        String compressionTemplateID = exerciseTemplateService.persist( new CompressionTemplate( rootUser, true, TimeUnit.MINUTES, 20, true, false, false, 0, (WorkshopTemplate)workshopTemplateService
            .findWorkshopTemplateByID( wsTemplateID ), "Erarbeite Massnahmenvorschläge aufgrund des bisherigen Inputs.", "Kompression", "Kompression Tool", Arrays.asList(
        ...
        String evaluationTemplateID = exerciseTemplateService.persist( new EvaluationTemplate( rootUser, true, TimeUnit.SECONDS, 60, false, true, false, 0, (WorkshopTemplate)workshopTemplateService
            .findWorkshopTemplateByID( wsTemplateID ), "Wie bewertest Du diese Lösungen?", "Evaluation", "Evaluation Tool", 5 ) );
    ...
    @SuppressWarnings( "unused" )
    public void configureDemoWorkshop()
    {
        UserService userService = ZhawEngine.getManagedObjectRegistry().getManagedObject( UserServiceImpl.class.getSimpleName() );
        RoleService roleService = ZhawEngine.getManagedObjectRegistry().getManagedObject( RoleServiceImpl.class.getSimpleName() );
        SessionService sessionService = ZhawEngine.getManagedObjectRegistry().getManagedObject( SessionServiceImpl.class.getSimpleName() );
    ...
    @SuppressWarnings( "unused" )
    public void configurePostWorkshop()
    {
        RoleService roleService = ZhawEngine.getManagedObjectRegistry().getManagedObject( RoleServiceImpl.class.getSimpleName() );
        UserService userService = ZhawEngine.getManagedObjectRegistry().getManagedObject( UserServiceImpl.class.getSimpleName() );
        ClientService clientService = ZhawEngine.getManagedObjectRegistry().getManagedObject( ClientServiceImpl.class.getSimpleName() );
    ...
    private void configureSBBWorkshop()
    {
        RoleService roleService = ZhawEngine.getManagedObjectRegistry().getManagedObject( RoleServiceImpl.class.getSimpleName() );
        UserService userService = ZhawEngine.getManagedObjectRegistry().getManagedObject( UserServiceImpl.class.getSimpleName() );
        ClientService clientService = ZhawEngine.getManagedObjectRegistry().getManagedObject( ClientServiceImpl.class.getSimpleName() );
